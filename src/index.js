(function(root, factory) {
  ...
  return function(node, settings) {
    ...
    self.init = function() {
      ...
      self.mx = self.cw / 2;
      self.my = self.ch / 2;
      self.currentHue = settings.currentHue || 170;
      self.partSpeed = settings.partSpeed || 5;
      self.partSpeedVariance = settings.partSpeedVariance || 10;
      self.partWind = settings.partWind || 50;
      self.partFriction = settings.partFriction || 5;
      self.partGravity = settings.partGravity || 1;
      self.hueMin = settings.hueMin || 150;
      self.hueMax = settings.hueMax || 200;
      self.fworkSpeed = settings.fworkSpeed || 2;
      self.fworkAccel = settings.fworkAccel || 4;
      self.hueVariance = settings.hueVariance || 30;
      self.flickerDensity = settings.flickerDensity || 20;
